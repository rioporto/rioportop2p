...
export default function DashboardPage() {
  ...
  const quickActions = [
    { title: 'Comprar Crypto', href: '/trading?action=buy', icon: 'buy', color: 'bg-secondary' },
    { title: 'Vender Crypto', href: '/trading?action=sell', icon: 'sell', color: 'bg-danger' },
    { title: 'Criar Oferta', href: '/trading/create', icon: 'create', color: 'bg-primary' },
    { title: 'Verificar KYC', href: '/profile', icon: 'kyc', color: 'bg-accent' },
  ];
